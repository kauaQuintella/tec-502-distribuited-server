...
public class GameService {
    ...
    public void createGame(String matchId, String player1Id, String player2Id) {
        ...
        try {
            ...
            // Usamos o timestamp como chave Long, pois não podemos usar o matchId
            long raftKey = System.currentTimeMillis();
    ...
    private void checkRoundCompletion(String matchId, GameState game, long raftKey) { // <-- MODIFICADO
        ...
        // Notifica ambos os jogadores sobre o resultado da ronda (APENAS UMA VEZ)
        if (roundWinnerId != null) {
            game.getScores().merge(roundWinnerId, 1, Integer::sum);
        }
        ...
        eventPublisher.publishMessage(gameTopic, gson.toJson(result));
